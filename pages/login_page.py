...
class LoginPage(BasePage):
    ...
    def fazer_login(self, usuario, senha):
        """
        Faz login com o usuário  e senha indicados
        """
        self.escrever(self.username_field, usuario)
        self.escrever(self.password_field, senha)
        self.clilcar(self.login_button)

    def verificar_mensagem_error_login_existe(self):
        """
    ...
    def verificar_texto_mensagem_erro_login(self, texto_esperado):
        """
        Verifica  o texto da mensagem de erro de login
        """
